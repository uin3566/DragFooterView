 ...
 * https://github.com/liaohuqiu/android-Ultra-Pull-To-Refresh/blob/master/ptr-lib/src/in/srain/cube/views/ptr/header/StoreHousePath.java
 * but modified the string orientation from horizontal to vertical
 */
            ...
            for (int j = 0; j < pointCount; j++) {
                ...
                for (int k = 0; k < 4; k++) {
                    ...
                    // y
                        ...
                        line[k] = (l + offsetForHeight) * scale;
                    }
                }
                list.add(line);
            }
            offsetForHeight += 72 + gapBetweenLetter;
        }
        return list;
    }
}
